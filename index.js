...
async function getData() {
  const res = await fetch(`https://65aab9eb081bd82e1d97a81b.mockapi.io/api`);
...
async function handleEdit(recordId, editedName) {
  ...
  try {
    const res = await fetch(
      `https://65aab9eb081bd82e1d97a81b.mockapi.io/api/${recordId}`,
      {
        method: "PUT",
        headers: {
